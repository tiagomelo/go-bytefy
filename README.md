...
[![unit tests](https://github.com/tiagomelo/go-bytefy/actions/workflows/unit-tests.yml/badge.svg?branch=main)](https://github.com/tiagomelo/go-bytefy/actions/workflows/unit-tests.yml)
